...
|   |   |   |   +-- semantic/                # YAML data catalog (Apache Ossie)
...
The backend loads YAML-based data catalogs ([Apache Ossie](https://github.com/apache/ossie), formerly OSI) that describe available tables, columns, and visualization hints. This context is injected into the AI's system prompt so it knows what data is available and how to visualize it.
