 ...
 * Adapted from sdsc-2025-congestion for frontend-react integration
 */
export class HttpClient {
   ...
   * @param {Object} [params.initialState] - Map context (layers, view state) for AI awareness
   */
    ...
    try {
      const response = await fetch(this.baseUrl, {
        ...
        body: JSON.stringify({
          ...
          initialState, // Include map context for AI awareness
        }),
      });
