...
const Sidebar = ({ chatOpen, onToggleChat }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Header primary={true} className={classes.headerPrimaryItem} chatOpen={chatOpen} onToggleChat={onToggleChat} />
      </div>
      ...
      <div className={classes.slides}>
        <SidebarSlide
          ...
          image={slide1Image}
          imageAttribution="Created with Gemini"
        />
        <SidebarSlide
          slide={2}
          shrinked={slideShrinked}
