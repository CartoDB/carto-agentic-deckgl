# @carto/maps-ai-tools -- Vercel AI SDK Backend
...
4. **Server builds system prompt** using `buildSystemPrompt()` from `@carto/maps-ai-tools` plus semantic context and custom instructions
...
### Library Prompt (`@carto/maps-ai-tools`)
